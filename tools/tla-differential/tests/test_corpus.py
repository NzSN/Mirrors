...
class CorpusTests(unittest.TestCase):
    def test_current_corpus_is_captured_with_frozen_input_bytes(self) -> None:
        ...
        self.assertEqual((len(captured.fixtures), sum(x.kind == "accepted" for x in captured.fixtures), sum(x.kind == "rejected" for x in captured.fixtures), len(captured.branch_ids)), (57, 32, 25, 75))
